...
exist other approaches \todo{citation needed}, they all require for every state
...
channel. \todo{talk about context split}
...
that is external to the calculus and depends on the type of messages. \todo{is
this bad?}
