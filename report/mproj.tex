...
The users define processes without knowledge of the concrete instantiation of \coqe{ST} and \coqe{MT}. As a result, they have no information about the type \coqe{MT M} required to build messages of type \coqe{B[M]}. To remedy this, process definitions are provided the assumption \coqe{mt}: for any type \coqe{S}, no matter what \coqe{MT} is, a message of base type \coqe{S} can be constructed. Processes can use this assumption to create messages out of Coq terms. \todo{introduce notation}

\coqi[9-12]{../src/Generalisation.v}
...
\todo{argue 1:1 correspondence with typing rules}

\coqi[20-24]{../src/Processes.v}
\coqi[26-30]{../src/Processes.v}
\coqi[32-37]{../src/Processes.v}
\coqi[39-43]{../src/Processes.v}
\coqi[45-49]{../src/Processes.v}
\coqi[51-51]{../src/Processes.v}
\coqi[53-53]{../src/Processes.v}

\coqi[140-152]{../src/Processes.v}
