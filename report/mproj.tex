...
\todo{
   When you introduce a grammar, you say "grammar for blah blah, ranged
   over by S". Why is there a fig 2.5 with standard channel types
   separately? I would put this together with session types in place of
   M::=... and explain why we need standard channels, in the session types
   section. In fact before section 2.2 don't talk about types at all, you
   are introducing them later.
   }
...
\todo{
   About the advantages and challenges in the design: the former has 3 and
   the latter 4 items, this seems like it was a bad design decision, that
   you lost more than you gain... Think about how to present it
   differently. There must be more gain than loss!
}    
