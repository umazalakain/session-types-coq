...
Slightly branching off from this project, we also want to formalise the operational semantics presented in \S \ref{reduction}, where we work with session types encoded as linear \picalc{} types, but avoid the need of sending over continuation channels. We do so by instead modifying the operational semantics of the linear \picalc{}, granting it the knowledge about how to manage session types encoded as linear types with heads and tails.
